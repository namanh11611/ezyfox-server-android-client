...
import com.tvd12.ezyfoxserver.client.util.ArrayUtils;
...
public final class EzyDataConverter {
    ...
    public static int[] collectionToPrimitiveIntArray (
        Collection<Integer> value) {
        return ArrayUtils.toPrimitive(value.toArray(new Integer[0]));
    }
    ...
    public static Boolean[] toBoolWrapperArray (boolean[] value) {
        return ArrayUtils.toWrapper(value);
    }
    ...
    public static Character[] toCharWrapperArray (
        byte[] value) {
        return ArrayUtils.toWrapper(byteArrayToCharArray(value));
    }
    ...
    public static Collection<Boolean> primitiveArrayToBoolCollection (
        boolean[] value) {
        return ArrayUtils.toList(value);
    }
