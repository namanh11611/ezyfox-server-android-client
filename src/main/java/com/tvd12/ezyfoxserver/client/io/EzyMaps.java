...
public final class EzyMaps {
    ...
    public static <K, V, M extends Map<K, V>> M newMap (
        K key,
        V value,
        M map
    ) {
    ...
    //=================================================================
    public static <K, V> Map<K, V> getValues (
        Map<K, V> map,
        Collection<K> keys
    ) {
    ...
    public static <K, V> List<V> getValues (
        Map<K, V> map,
        EzyPredicate<V> predicate
    ) {
    ...
    public static <K, E> void addItemsToSet (
        Map<K, Set<E>> map,
        K key,
        E... items
    ) {
    ...
    @SuppressWarnings("unchecked")
    public static <K, E> void addItemsToList (
        Map<K, List<E>> map,
        K key,
        E... items
    ) {
